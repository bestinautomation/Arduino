...
byte data1[14] = {"Amritpal Singh"};  //The first data that needs to be written to the tag.
byte data2[16] = {"Bestin Automation"};  //The second data that needs to be written to the tag.
